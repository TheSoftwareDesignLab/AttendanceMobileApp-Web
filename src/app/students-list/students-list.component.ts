...
export class StudentsListComponent {
  ...
  constructor(private route: ActivatedRoute, public dialog: MatDialog, private db: AngularFirestore, private formBuilder: FormBuilder, public errorMessagesService: ErrorMessagesService) {
    const today = new Date();
    this.route.paramMap.subscribe(params => {
      this.course = params.get('courseID');
    });
    this.students = db.collection('2019-20').doc(this.course+"").collection('students').valueChanges();
